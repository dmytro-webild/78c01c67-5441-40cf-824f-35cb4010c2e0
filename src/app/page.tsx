...
export default function LandingPage() {
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        { id: "3", name: "Luis D.", handle: "@luisd", testimonial: "Excelente ambiente y muy buena atención. La Picanha es obligatoria.", rating: 4, icon: Star },
      ]}
    />
  </div>
  ...
  <div id="footer" data-section="footer">
      ...
      logoText="PICANHA"
      columns={[
        { title: "Contacto", items: [{ label: "5504 5249", href: "tel:55045249" }, { label: "WhatsApp", href: "https://wa.me/50555045249" }] },
        { title: "Social", items: [{ label: "Instagram", href: "https://instagram.com/picanhabt.ni" }] },
      ]}
      copyrightText="© 2024 Picanha Brazilian Taste."
    />
  </div>
      </ReactLenis>
    </ThemeProvider>
