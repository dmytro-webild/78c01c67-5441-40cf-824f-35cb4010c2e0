...
export default function LandingPage() {
  ...
  <div id="value" data-section="value">
      ...
      features={[
        {
          id: "1",
          title: "Pagas por peso",
          description: "Control total del precio. Tú eliges la porción. Tú decides el precio.",
          imageSrc: "http://img.b2bpic.net/free-photo/assortment-frozen-food-table_23-2148969442.jpg",
        },
        {
          id: "2",
          title: "Cortes premium",
          description: "Disfruta de picanha, ribeye y churrasco con calidad insuperable.",
          imageSrc: "http://img.b2bpic.net/free-photo/meat-prepared-cooking_23-2148599755.jpg",
        },
        {
          id: "3",
          title: "Opciones para todos",
          description: "De platos keto a opciones veganas frescas, cuidamos cada gusto.",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-delicious-dinner-fried-chicken-dish-with-various-spices-foods-garlics-fallen-oil-bottle-lemon-onions-mushrooms-kumquats_140725-159368.jpg",
        },
      ]}
  ...
  <div id="experience" data-section="experience">
      ...
      faqs={[
        {
          id: "1",
          title: "1. Elige tus carnes",
          content: "Selecciona tus cortes favoritos directamente de nuestra parrilla al carbón.",
        },
        {
          id: "2",
          title: "2. Agrega acompañamientos",
          content: "Complementa tu plato con nuestra variedad de guarniciones frescas.",
        },
        {
          id: "3",
          title: "3. Paga por peso",
          content: "Pesa tu plato y paga exactamente por lo que vas a disfrutar.",
        },
        {
          id: "4",
          title: "4. Disfruta",
          content: "Vive la auténtica experiencia del fuego brasileño en Managua.",
        },
      ]}
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        ...
        },
        {
          ...
          name: "Brigadeiro",
          price: "Postre",
          imageSrc: "http://img.b2bpic.net/free-photo/chocolate-balls-with-cocoa-powder_114579-12445.jpg",
        },
        {
          id: "p5",
  ...
  <div id="footer" data-section="footer">
      ...
      columns={[
        ...
        },
        {
          ...
          items: [
            {
              label: "Mié-Sáb: 11:30AM – 9:30PM",
              href: "#",
            },
            {
              label: "Dom: 12:00PM – 4:00PM",
              href: "#",
            },
            {
              label: "Lun-Mar: 11:30AM – 3:00PM",
              href: "#",
            },
          ],
        },
